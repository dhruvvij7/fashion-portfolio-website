...
export default function Look1Page() {
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="pt-24 pb-12 px-6">
        <div className="max-w-6xl mx-auto text-center">
          <p className="text-sm tracking-widest text-rose uppercase mb-4">Look 1</p>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-light text-foreground mb-6">
            Effortless Sensuality
          </h1>
          <p className="text-foreground/70 max-w-2xl mx-auto text-lg">
            A comprehensive gallery of the first look styling variations
          </p>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="relative aspect-[3/4] bg-surface mb-8 overflow-hidden">
            <Image
              ...
              alt={`Look 1 - Image ${currentIndex + 1}`}
              fill
